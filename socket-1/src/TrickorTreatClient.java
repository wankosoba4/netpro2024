...
public class TrickorTreatClient {
    ...
    public static void main(String arg[]) {
        try {
            ...
            System.out.println("HappyHallowWeen!");
            ObjectOutputStream oos = new ObjectOutputStream(socket.getOutputStream());

            System.out.println("合言葉を入力してください(例:Trick or Treat!) ↓");
            String message = scanner.next();
            System.out.println("お菓子、またはいたずらの内容を入力してください ↓");
